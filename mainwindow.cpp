...
void MainWindow::on_Modifier_Vehicule_clicked()
{
    ...
    bool test1=tmpVehicule.rechercher(i);
    if(test1)
    {
        click = new QMediaPlayer();
...
void MainWindow::on_Supprimer_vehicule_clicked()
{
    ...
    bool test1=tmpVehicule.rechercher(id);
...
void MainWindow::on_Modifier_Parking_clicked()
{
    ...
    bool test1=tmpParking.rechercher(R);
       if(test1)
       {
           click = new QMediaPlayer();
           click->setMedia(QUrl("qrc:/sounds/Parking_modifie.mp3"));
           click->play();
       if (control==true)
       {
      Parking P(R,n,A,nb);
       ...
       if (test)
           {
           ui->tableView_2->setModel(tmpParking.afficher());
          QMessageBox::information(nullptr,QObject::tr("Modifier Parking"),
           ...
           QMessageBox::critical(nullptr, QObject::tr("Modifier un Parking"),
                       QObject::tr("Erreur !.\n"
                                   "Click Ok to close."), QMessageBox::Ok);
       }else QMessageBox::critical(nullptr, QObject::tr("Modifier un Parking"),
                                   QObject::tr("Parking non existant !.\n"
                                               "Click Ok to close."), QMessageBox::Ok);
   }
...
void MainWindow::on_Supprimer_Parking_clicked()
{
    ...
    bool test1=tmpParking.rechercher(ref);
    if(test1){
...
void MainWindow::on_Tri_vehicule_currentTextChanged(const QString &arg1)
{
    ...
    if(arg1 == "Trier par ID"){
         ...
         ui->tableView_2->setModel(tmpVehicule.tri_id());}
            else if(arg1 =="Trier par date de mise en marche"){
...
{
    player->setMedia(QUrl("qrc:/sounds/background.mp3"));
         player->play();
